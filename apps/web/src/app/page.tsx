...
import { Exercise, Swimlane, UserProgress, ViewMode } from '@aura/types';
...
export default function Home() {
  ...
  return (
    <main className={`bg-dark-950 text-slate-100 flex flex-col selection:bg-neon-cyan selection:text-dark-950 ${
      viewMode === 'tree' ? 'h-screen max-h-screen overflow-hidden' : 'min-h-screen'
    }`}>
