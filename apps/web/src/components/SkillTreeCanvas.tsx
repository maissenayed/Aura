...
import { Exercise, Swimlane, UserProgress } from '@aura/types';
...
export const SkillTreeCanvas: React.FC<SkillTreeCanvasProps> = ({
  ...
  return (
    <div className="relative w-full h-full min-h-0 bg-dark-950 bg-grid-pattern select-none overflow-hidden z-0">

      {/* Path Focus Mode Status Indicator */}
      {focusedNodeId && (
        <div className="absolute top-4 left-6 z-20 flex items-center gap-2 px-3 py-1.5 rounded-xl bg-dark-900/90 border border-amber-500/40 text-xs font-semibold text-amber-300 backdrop-blur-md shadow-xl animate-in fade-in">
      ...
      >
        ...
        <Controls 
          ...
          className="!bg-dark-900/95 !border-slate-800/90 !text-slate-300 !z-30" 
        />
        ...
        <MiniMap
          ...
          className="!bg-dark-900/95 !border-slate-800/90 !z-30"
        />
      </ReactFlow>
    </div>
  );
